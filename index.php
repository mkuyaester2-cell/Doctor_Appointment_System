    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8 animate-fade-in-up">
                ...
                <h1 class="text-5xl lg:text-7xl font-bold tracking-tight text-slate-900 leading-tight">
                    Your Health, <br>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-4">
                    <a href="patient/register.php" class="inline-flex justify-center items-center px-8 py-4 text-lg font-semibold rounded-full text-white bg-primary-600 hover:bg-primary-700 transition-all shadow-lg shadow-primary-500/30 hover:shadow-primary-600/40 hover:-translate-y-1">
                        Get Started
                        <i class="fa-solid fa-arrow-right ml-2"></i>
                    </a>
                    <a href="patient/browse-doctors.php" class="inline-flex justify-center items-center px-8 py-4 text-lg font-semibold rounded-full text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 transition-all hover:-translate-y-1 shadow-sm">
                        Find a Doctor
                    </a>
                </div>
