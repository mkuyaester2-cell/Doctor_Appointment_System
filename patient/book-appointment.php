                    ...
                    <div class="p-8">
                        ...
                        <form id="bookingForm" method="POST" class="space-y-8">
                            ...
                            <div id="slotsContainer" class="hidden animate-fade-in-up">
                                ...
                                <div id="slotsGrid" class="grid grid-cols-3 sm:grid-cols-4 gap-3">
                                </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-3xl shadow-lg border border-slate-100 p-6 sticky top-24">
                    <div class="flex items-center gap-4 mb-6 border-b border-slate-100 pb-6">
                        <img src="<?php echo $doctor['profile_image'] ? htmlspecialchars($doctor['profile_image']) : 'https://ui-avatars.com/api/?name=' . urlencode($doctor['full_name']) . '&background=random&size=128'; ?>" class="w-20 h-20 rounded-2xl object-cover shadow-md">
                        <div>
...
function renderCalendar() {
    ...
    for (let i = 1; i <= totalDays; i++) {
        ...
        if (isBeforeToday || !isWorkingDay) {
            ...
            if(!isWorkingDay) {
                btn.classList.add('bg-slate-50', 'opacity-50');
                btn.title = "Doctor not available on this day of week";
            } else {
                btn.title = "Date has passed";
            }
        } else {
            if (isSelected) {
