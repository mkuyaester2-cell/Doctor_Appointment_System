    ...
    <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-slate-100">
        ...
        <div class="text-center mt-6 space-y-2">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="patient/register.php" class="font-bold text-primary-600 hover:text-primary-500 border border-primary-200 px-4 py-2 rounded-xl hover:bg-primary-50 transition-colors w-full sm:w-auto">Register as Patient</a>
                <a href="doctor/register.php" class="font-bold text-emerald-600 hover:text-emerald-500 border border-emerald-200 px-4 py-2 rounded-xl hover:bg-emerald-50 transition-colors w-full sm:w-auto">Register as Doctor</a>
            </div>
        </div>
    </div>
</div>
